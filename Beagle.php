...
<div class="mySlides fade">
  ...
  <center><img src="img/download (10).jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Text</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <center><img src="img/images (5).jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Two</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <center><img src="img/maxresdefault.jpg" width:40% height=250px style="border-radius:50px;"></center>
...
function showSlides() {
  ...
  setTimeout(showSlides, 3000); // Change image every 2 seconds
    ...
    <div class="xy">Beagles are active, energetic dogs who need at least an hour of exercise every day. This doesn't mean just letting them out in the backyard. Beagles were bred to work in packs and are happiest when they have company. A Beagle who is left alone inside or outside for long periods of time will tend to become destructive.</div>
                             <center> <div class="xyz"><h1><u>Beagle</u></h1></div>
...
Pattern : Ticking<br>
					            ...
					            if (check_if_added_to_cart(18)) { 
					                echo '<a href="#" class="btn btn-block btn-success" disabled style="width:200px; left:650px; top:-110px; position:relative; border-radius:50px;">Added to cart</a>';
                                             	...
                                             	?>
					                         <center><a href="cart-add.php?id=18" name="add" value="add" class="cart">Add to cart</a></center>
					            <?php
					             }
                                ?>
