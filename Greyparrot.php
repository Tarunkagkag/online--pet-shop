...
<div class="mySlides fade">
  ...
  <center><img src="img/download (27).jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Text</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <center><img src="img/image-51185-800.jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Two</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <center><img src="img/greyparrot_larry_ZA_9597.jpg" width:40% height=250px style="border-radius:50px;"></center>
...
function showSlides() {
  ...
  setTimeout(showSlides, 3000); // Change image every 2 seconds
    ...
    <div class="xy">The grey parrot is a highly social species which relies on a flock-type structure, even when raised in captivity. Because they are so dependent on the other birds within their flock, much of their speech and vocal ability is acquired through interaction with the humans with whom they reside.</div>
                             <center> <div class="xyz"><h1><u>Grey Parrot</u></h1></div>
...
<b>Behaviour</b>:African greys are social parrots that need a lot of hands-on time, however, they aren’t “cuddlebugs.” They will tolerate some head scratching and a little bit of petting, but they do not appreciate intense physical contact, though some individuals don’t mind a little snuggling. Every bird has individual tastes and preferences. A grey can also become a “one person bird,” even if every member of the household socializes with it from the beginning.
					            ...
					            if (check_if_added_to_cart(58)) { 
					                echo '<a href="#" class="btn btn-block btn-success" disabled style="width:200px; left:650px; top:-110px; position:relative; border-radius:50px;">Added to cart</a>';
                                             	...
                                             	?>
					                         <center><a href="cart-add.php?id=58" name="add" value="add" class="cart">Add to cart</a></center>
					            <?php
					             }
                                ?>
