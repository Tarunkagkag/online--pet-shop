...
<div class="mySlides fade">
  ...
  <center><img src="img/A-school-of-Oscar-Fish.jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Text</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <center><img src="img/how-to-take-care-of-Oscar-Fish.jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Two</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <center><img src="img/Oscar.jpg" width:40% height=250px style="border-radius:50px;"></center>
...
Longevity Range: 2-3 yrs.<br>
					            ...
					            if (check_if_added_to_cart(48)) { 
					                echo '<a href="#" class="btn btn-block btn-success" disabled style="width:200px; left:650px; top:-110px; position:relative; border-radius:50px;">Added to cart</a>';
                                             	...
                                             	?>
					                         <center><a href="cart-add.php?id=48" name="add" value="add" class="cart">Add to cart</a></center>
					            <?php
					             }
                                ?>
