...
<div class="mySlides fade">
  ...
  <center><img src="img/Parrot-8.jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Text</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <center><img src="img/images (21).jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Two</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <center><img src="img/images (22).jpg" width:40% height=250px style="border-radius:50px;"></center>
...
function showSlides() {
  ...
  setTimeout(showSlides, 3000); // Change image every 2 seconds
    ...
    <div class="xy">Parrots are tropical birds and live in warm places. Parrots are very intelligent birds as they can mimic human speech. Parrots live in the bills of trees. Parrots eat fruits such as grapes, berries, mangoes; as well as leaves and crops.</div>
                             <center> <div class="xyz"><h1><u>Parrot</u></h1></div>
...
<b>Habits</b>:Most parrots are social birds that live in groups called flocks. African grey parrots live in flocks with as many as 20 to 30 birds.Many species are monogamous and spend their lives with only one mate. The mates work together to raise their young. Parrots throughout the flock communicate with one another by squawking and moving their tail feathers. 
					            ...
					            if (check_if_added_to_cart(54)) { 
					                echo '<a href="#" class="btn btn-block btn-success" disabled style="width:200px; left:650px; top:-110px; position:relative; border-radius:50px;">Added to cart</a>';
                                             	...
                                             	?>
					                         <center><a href="cart-add.php?id=54" name="add" value="add" class="cart">Add to cart</a></center>
					            <?php
					             }
                                ?>
