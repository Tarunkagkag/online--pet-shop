...
<div class="mySlides fade">
  ...
  <center><img src="img/Boesemani-rainbow-fish.jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Text</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <center><img src="img/dabbf946bd79f6d5213e67017e0550b5.jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Two</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <center><img src="img/images (19).jpg" width:40% height=250px style="border-radius:50px;"></center>
...
function showSlides() {
  ...
  setTimeout(showSlides, 3000); 
    ...
    <div class="xy">They are quite durable and normally can fight off most aquarium diseases. The Boeseman's Rainbowfish are omnivores and are opportunistic feeders in the wild, with a natural diet of small crustaceans, insects, and some vegetation. In captivity they should be given a high quality diet to encourage good coloration.</div>
                             <center> <div class="xyz"><h1><u>Rainbow Fish</u></h1></div>
...
Skin Type:Scales<br>
Length:5cm - 11cm (2in - 4.5in)<br>
Favourite food:Algae<br>
Longevity Range: 4-5 yrs.<br>
					            ...
					            if (check_if_added_to_cart(40)) { 
					                echo '<a href="#" class="btn btn-block btn-success" disabled style="width:200px; left:650px; top:-110px; position:relative; border-radius:50px;">Added to cart</a>';
                                             	...
                                             	?>
					                         <center><a href="cart-add.php?id=40" name="add" value="add" class="cart">Add to cart</a></center>
					            <?php
					             }
                                ?>
