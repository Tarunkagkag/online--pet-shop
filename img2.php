...
.xyz{
    ...
    <body>
        ...
        <br><br><br><br><br>
                          ...
                          <img src="img\Aegean-cat-from-the-Greek-islands-24.jpg" alt="Responsive image" width="300px" height="300px"  style="border-radius:50px; position:relative; left:100px; top:0px;">    
    <div class="xy">Aegean Cats tend to be smart and lively, with good communication skills. They are generally friendly toward people and can be excellent cats for families with children.<br>The Aegean Cat usually likes being part of the family and is well suited to most types of homes</div>
                             <center> <div class="xyz"><h1><u>Aegean </u></h1></div>
...
Colors: white-black, orange-white<br>
Pattern : Ticking<br>
...
Overall Grooming Needs: Low
					            ...
					            if (check_if_added_to_cart(26)) { 
					                echo '<a href="#" class="btn btn-block btn-success" disabled style="width:200px; left:800px; top:-120px; position:relative; border-radius:50px;">Added to cart</a>';
                                             	...
                                             	?>
					                         <center><a href="cart-add.php?id=26" name="add" value="add" class="cart">Add to cart</a></center>
					            <?php
					             }
                                ?>
    </body>
