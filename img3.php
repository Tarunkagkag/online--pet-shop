...
.xyz{
    ...
    <body>
        ...
        <br><br><br><br><br>
                          ...
                          <img src="img\image (1).jpg" alt="Responsive image" width="300px" height="300px"  style="border-radius:50px; position:relative; left:100px; top:0px;">    
    <div class="xy">American bobtails are known for their wild appearance and short bobbed tails. These cats make loving, loyal, and playful pets.<br>These cats love to be around humans and have a sweet, gentle nature that makes them wonderful companions.</div>
                             <center> <div class="xyz"><h1><u>American Bobtail</u></h1></div>
                             <div class="x"></div>
...
Overall Grooming Needs: Low
					            ...
					            if (check_if_added_to_cart(27)) { 
					                echo '<a href="#" class="btn btn-block btn-success" disabled style="width:200px; left:800px; top:-120px; position:relative; border-radius:50px;">Added to cart</a>';
                                             	...
                                             	?>
					                         <center><a href="cart-add.php?id=27" name="add" value="add" class="cart">Add to cart</a></center>
					            <?php
					             }
                                ?>
    </body>
