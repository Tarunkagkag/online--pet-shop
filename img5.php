...
.xyz{
    ...
    <body>
        ...
        <br><br><br><br><br>
                          ...
                          <img src="img\download.jpg" alt="Responsive image" width="300px" height="300px"  style="border-radius:50px; position:relative; left:100px; top:0px;">    
    <div class="xy">American Ringtails are loving cats that get along well with other pets, children, and family members. They can be shy around strangers but tend to warm up quickly. Since this is a new breed, locating a kitten may be difficult.</div>
                             <center> <div class="xyz"><h1><u>American Ringtail</u></h1></div>
...
Overall Grooming Needs: Low
					            ...
					            if (check_if_added_to_cart(29)) { 
					                echo '<a href="#" class="btn btn-block btn-success" disabled style="width:200px; left:800px; top:-120px; position:relative; border-radius:50px;">Added to cart</a>';
                                             	...
                                             	?>
					                         <center><a href="cart-add.php?id=29" name="add" value="add" class="cart">Add to cart</a></center>
					            <?php
					             }
                                ?>
    </body>
