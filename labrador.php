...
<div class="mySlides fade">
  ...
  <center><img src="img/labrador-retriever-1210559__480.jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Text</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <center><img src="img/Yellow-Labrador-Retriever-happy-in-grass-.jpg.optimal.jpg" width:40% height=250px style="border-radius:50px;"></center>
  <!-- <div class="text">Caption Two</div> -->
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <center><img src="img/640px-Labrador_on_Quantock_(2175262184).jpg" width:40% height=250px style="border-radius:50px;"></center>
...
Male : medium: 40-60 kg.<br>
Female: medium: 40-60 kg.<br>

Eye color:<br>
brown hazel , brown <br>

Expectations:<br>
Longevity Range: 20-30 yrs.<br>
...
Pattern : Ticking<br>
					            ...
					            if (check_if_added_to_cart(13)) { 
					                echo '<a href="#" class="btn btn-block btn-success" disabled style="width:200px; left:650px; top:-110px; position:relative; border-radius:50px;">Added to cart</a>';
                                             	...
                                             	?>
					                         <center><a href="cart-add.php?id=13" name="add" value="add" class="cart">Add to cart</a></center>
					            <?php
					             }
                                ?>
