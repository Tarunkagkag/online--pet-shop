<html>
    ...
    <body>
        ...
        <button  class="button" style="vertical-align:middle" type="submit" name="submit"><span>NEXT</span></button>
</form>
...
<?php
        if(isset($_POST['submit'])) 
        {
          ...
          $a=$_POST['name'];
          $b=$_POST['fav'];
          $sql="INSERT INTO `billing`(`B_name`, `B-type`) VALUES ('$a','$b')";
...
<html>
    <head>
                ...
                <meta charset="UTF-8">
        <title>Fruit Store | Success</title>
